...
# visual crypto
core-platform-cppflags += -I$(arch-dir)/visual-crypto/include
core-platform-cppflags += -I$(arch-dir)/chacha20
core-platform-subdirs += $(arch-dir)/visual-crypto
core-platform-subdirs += $(arch-dir)/chacha20
...
arm32-platform-cflags-no-hard-float ?= -mfloat-abi=softfp
...
# 191107 dhkim: Override compile flag. Os is too conservative to us
platform-cflags-optimization ?= -O2
