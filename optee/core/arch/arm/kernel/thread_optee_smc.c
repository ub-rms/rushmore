        ...
        uint32_t a3 __unused)
{
    ...
    /* Receives Rushmore Entry Call */
    if (a0 == OPTEE_SMC_RUSHMORE) {

        /* Chang Min's*/
        rushmore_entry(a1, a2);
		
        /* DongHwi's */
        //uint32_t vfp_status = thread_kernel_enable_vfp();

		/* ARM Neon intrinsics are enabled here */
		//vcrypto_entry(a1, a2, a3);
    ...
    /* Receives Rushmore Thread Entry Call */ 
    if (a0 == OPTEE_SMC_RUSHMORE_THREAD) {
        // TODO: Temporarily removed 
        // rushmore_thread_entry(a1, a2);
        return OPTEE_SMC_RETURN_OK;
    }
